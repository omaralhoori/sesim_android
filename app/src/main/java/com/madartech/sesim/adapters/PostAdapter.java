...
import com.madartech.sesim.CommentsActivity;
import com.madartech.sesim.FollowersActivity;
...
//        }
        ...
        holder.audio_url.setText(post.getPostAudio());
        if (!post.getPublisher().equals(firebaseUser.getUid())){
            holder.more.setVisibility(View.INVISIBLE);
        }
        if(post.getPostAudio().length() == 0)
...
//
        ...
        holder.playBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    mp.setDataSource(holder.audio_url.getText().toString());
                    mp.prepare();
                    mp.start();
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView name, likes, comments, audio_url;
    ...
    private void publisherInfo(final ImageView image_profile, final TextView name, final String userid){
    ...
    private void isLiked(final String postid, final ImageView likeButton){
